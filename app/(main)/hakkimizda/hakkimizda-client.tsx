        ...
        <div className="mx-auto max-w-[1200px] px-4 text-center">
          <FadeIn>
            ...
            <p className="text-gray-300 max-w-2xl mx-auto text-lg">
              SBA Elektrik Elektronik Mühendislik olarak güvenilir çözüm ortağınızız.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <SlideIn from="left" className="w-full md:w-1/2">
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden shadow-lg">
                <Image
                  src="/images/saha/antalya-elektrik-pano-odasi.webp"
                  alt="SBA Mühendislik Antalya endüstriyel elektrik pano odası uygulaması"
                  fill
            ...
            <SlideIn from="right" className="w-full md:w-1/2">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                SBA Elektrik Elektronik Mühendislik, Antalya’nın Kepez ilçesinde kurulmuş olup, elektrik mühendisliği alanında 15 yılı aşkın deneyime sahiptir.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
