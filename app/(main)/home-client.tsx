...
const fieldPhotos = [
  { src: '/images/saha/antalya-ges-elektrik-panosu.webp', alt: 'SBA Mühendislik Antalya GES elektrik panosu uygulaması' },
  { src: '/images/saha/antalya-jenerator-sistemi.webp', alt: 'Antalya jeneratör sistemi saha uygulaması' },
  { src: '/images/saha/antalya-jenerator-transfer-panosu.webp', alt: 'Antalya jeneratör transfer panosu uygulaması' },
  { src: '/images/saha/antalya-kompanzasyon-panosu.webp', alt: 'Antalya kompanzasyon panosu çalışması' },
  { src: '/images/saha/antalya-ana-dagitim-panosu-bara.webp', alt: 'Antalya ana dağıtım panosu bara uygulaması' },
  { src: '/images/saha/antalya-elektrik-pano-odasi.webp', alt: 'Antalya endüstriyel elektrik pano odası' },
  { src: '/images/saha/antalya-endustriyel-elektrik-panolari.webp', alt: 'Antalya endüstriyel elektrik panoları uygulaması' },
  { src: '/images/saha/antalya-kumanda-panosu.webp', alt: 'Antalya elektrik kumanda panosu uygulaması' },
  { src: '/images/saha/antalya-sigorta-dagitim-panosu.webp', alt: 'Antalya sigorta dağıtım panosu uygulaması' },
  { src: '/images/saha/antalya-elektrik-periyodik-kontrol.webp', alt: 'Antalya elektrik periyodik kontrol ölçümü' },
  { src: '/images/saha/antalya-topraklama-olcumu.webp', alt: 'Antalya topraklama ölçümü uygulaması' },
  { src: '/images/saha/antalya-yagli-tip-trafo-bakimi.webp', alt: 'Antalya yağlı tip trafo bakım çalışması' },
  { src: '/images/saha/antalya-kuru-tip-trafo-bakimi.webp', alt: 'Antalya kuru tip trafo bakım çalışması' },
  { src: '/images/saha/antalya-yeni-abonelik-kablo-kanali.webp', alt: 'Antalya yeni elektrik aboneliği kablo kanalı çalışması' },
  { src: '/images/saha/antalya-yeni-abonelik-sayac-panosu.webp', alt: 'Antalya yeni abonelik sayaç panosu uygulaması' },
]
    ...
    <>
      ...
      <section className="relative h-[600px] md:h-[700px] overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/saha/antalya-jenerator-transfer-panosu.webp"
            alt="SBA Mühendislik Antalya jeneratör transfer panosu uygulaması"
            fill
          ...
          <div className="max-w-2xl">
            ...
            <SlideIn from="left" delay={0.1}>
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-tight mb-4">
                Antalya’da Profesyonel <span className="text-primary">Elektrik Mühendisliği</span> Hizmetleri
              </h1>
            </SlideIn>
            <FadeIn delay={0.3}>
              <p className="text-lg md:text-xl text-gray-300 mb-8 leading-relaxed">
                Elektrik proje ve taahhüt, GES kurulumu, trafo bakım ve kurulumu, OG işletme sorumluluğu, güç artışı ve periyodik kontrollerde güvenilir çözüm ortağınız.
              </p>
            </FadeIn>
            <FadeIn delay={0.5}>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-[1200px] px-4">
          <FadeIn>
            <div className="text-center mb-12">
              <span className="text-primary font-medium text-sm uppercase tracking-wider">Sahadan Görüntüler</span>
              <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight mt-2">
                Gerçek <span className="text-primary">Uygulamalarımız</span>
              </h2>
              <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">
                Trafo, elektrik panosu, jeneratör, GES, yeni abonelik ve periyodik kontrol çalışmalarımızdan seçilmiş saha fotoğrafları.
              </p>
            </div>
          </FadeIn>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {fieldPhotos.map((photo) => (
              <div key={photo.src} className="relative aspect-[4/3] overflow-hidden rounded-lg shadow-md">
                <Image
                  src={photo.src}
                  alt={photo.alt}
                  fill
          ...
          <FadeIn>
            <div className="text-center mb-12">
              <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight">
                Rakamlarla <span className="text-primary">SBA Mühendislik</span>
              </h2>
            </div>
          </FadeIn>
